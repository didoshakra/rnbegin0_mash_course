...
export function ViewAllStudentScreen({navigation}) {
  ...
  useEffect(() => {
    ...
    //     setItems(temp);
    //     console.log('StudentScreen/get/results=', results);
      ...
      <View style={styles.mainContainer}>
        ...
        <View style={{flexDirection: 'row', justifyContent: 'space-between'}}>
          ...
          <TouchableOpacity
            ...
            <Text style={styles.touchableOpacityText}>View Students</Text>
          </TouchableOpacity>
          {/* <TouchableOpacity
            style={styles.touchableOpacity}
            onPress={() => navigation.navigate('student-list')}
            >
            <Text style={styles.touchableOpacityText}>StudListMap</Text>
          </TouchableOpacity> */}
        </View>
        {/* <StudentListScreen /> */}
      </View>
